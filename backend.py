...
# Supervisor Agent and input Guardrail
...
def final_agent(state: TravelState):
    ...
    final_prompt = f"""
        ...
        Budget Analysis: {state.get('budget_results', '')}
...
def resume_travel_agent(thread_id: str, approved: bool, feedback: str = ""):
    """Resume the pause Langraph thread after human review"""
